    ...
    <div class="container space-2">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-9">
                ...
                <h4 class="h2 text-center mb-5">免责声明</h4>
                <p>
                ...
                <p>6、图片版权</p>
                <p>青柠子矜网使用的任何图片，包含但不局限于人物、场景、写真、艺术等，所有版权都归于 <a
                        title="图片版权" href="https://pixabay.com/zh/users/AdinaVoicu-485024/"
                        rel="copyright nofollow">AdinaVoicu</a>
                    所有，青柠子矜网获得授权，<span
                ...
                <ol class="list-style mt-3">
                    ...
                    <li>青柠子矜网一般会对授权的文章中内容进行二次演绎，编译幅度不超过5%。<br/>其中所具有的独特样式、展现风格、图片(<span
                            class="badge bg-primary">遵循免责声明6</span>)归青柠子矜网所有，文字、文章为作者所有。
                    </li>
                    <li>
                    ...
                    <li>青柠子矜网“仅”对提供文章授权的个体/企业提供便利性著作权保护，其中体现于手机端浏览时具有独特<a
                            data-bs-placement="top" target="_blank" href="{{env('APP_PATH')}}"
                    ...
                    <li>文章授权及联系方式(<span class="badge bg-primary">同下</span>)</li>
                </ol>
                <p class="list-terms mt-3">8、补充声明</p>
                <ol class="list-style mt-3">
                    ...
                    <li>违法和不良信息举报电话 <i class="ci-phone"></i>：110 、 010-12321 、12377。</li>
                    <li>违法和不良信息举报邮箱 <i class="ci-mail"></i>：jubao@12377.cn 。</li>
                    <li><a rel="nofollow" target="_blank" href="https://creativecommons.org/licenses/by-nc-nd/4.0/">知识共享署名-非商业性使用-禁止演绎
                            4.0 国际许可协议</a></li>
                </ol>
